...
setTimeout(function() {
  showNotification("Welcome to LlamaOS", "Feel free to explore the latest UI and all the exciting new features!");
}, 4500);
...
const buttons = [
  ...
  { text: "Defualt Title & Favicon", title: "LlamaOS", favicon: "/media/favicons/llamaos.png" }
];
...
document.addEventListener("keydown", function(event) {
  ...
  if (typedKeys === "842571") {
    window.location.href = "/directories/adminsettings.html";
