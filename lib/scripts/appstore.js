...
const config = [
  ...
  },
  {
    imageSrc: '/media/icons/fillericon.png',
    title: 'GBA Emulator',
    description: 'No ROMs Provided',
    function1: () => {
      const gba = `
      <iframe src="/gbajs3/index.html" frameborder="0" style="width: 100%; height: 100%; border: none; margin: none;"></iframe>
    `
      const gbaemulator = {
        id: 9,
        imageSrc: '/media/icons/fillericon.png',
        text: 'GBA Emulator',
        clickFunction: function() {
          createWindow('GBA Emulator', gba, '60%', '70%');
        }
      };
      createApp(gbaemulator);
      console.log('Successfully installed the app "GBA Emulator" with the ID of "9".');
    },
    function2: () => {
      removeAppById(9);
      console.log('Successfully installed the app "GBA Emulator" with the ID of "9".');
