...
const config = [
  {
    ...
    function1: () => {
      const notesApp = `
          <iframe src="https://justnotepad.com/" frameborder="0" style="width: 100%; height: 100%; border: none; margin: none;"></iframe>
        `
      const notes = {
        id: 5,
        imageSrc: '/media/icons/notes.png',
  ...
  },
  {
    ...
    description: 'A good app for reminding you to do homeowrk. (Does require a signup)',
    function1: () => {
      const homework = `
      <iframe src="https://app.mystudylife.com/dashboard" frameborder="0" style="width: 100%; height: 100%; border: none; margin: none;"></iframe>
    `
  ...
  },
  {
    ...
    function1: () => {
      const school = `
      <iframe src="https://stratfordschools.schoology.com/home" frameborder="0" style="width: 100%; height: 100%; border: none; margin: none;"></iframe>
    `
      const schoology = {
        id: 7,
        imageSrc: '/media/icons/schoology.png',
