...
const config = [
  ...
  },
  {
    ...
    function1: () => {
      const animal = `
      <iframe src="https://https://replit.com/@Trapjaww/Animal-Crossing-V3?embed=true" frameborder="0" style="width: 100%; height: 100%; border: none; margin: none;"></iframe>
    `
      const animalcrossing = {
        ...
        clickFunction: function() {
          createWindow('Animal Crossing', animalcrossing, '60%', '70%');
        }
      };
