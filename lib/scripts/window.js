...
<head>
    ...
    <title>Welcome to LlamaOS Beta!</title>
    <style>
        .container {
            max-width: 800px;
            margin: 0 auto;
...
<body>
    <div class="container">
        ...
        <hr>
        <p>Discover LlamaOS: A Glimpse into the Future</p>
        <p>Welcome to LlamaOS, where innovation meets accessibility. As you step into the world of DuckOS, you're entering an unparalleled web-based operating system, meticulously designed to redefine your digital experience. Although this version is still in its beta phase, the journey ahead promises a new era of computing freedom.</p>
        ...
        <p>juegos On: Entertainment at Your Fingertips</p>
        <p>Get ready to juegos like never before. LlamaOS comes equipped with a vast array of captivating juegos suitable for all ages. Whether you're a casual juegosr or a hardcore enthusiast, our juegos library has something to offer. With intuitive controls and seamless integration, your gaming adventures are just a click away.</p>
        <p>Unrestricted Access with Built-In Proxies</p>
        <p>Say goodbye to online barriers. LlamaOS comes with the best flagship proxies such as Cobalt, Rammerhead and Immortal.</p>
    </div>
</body>
</html>
...
const juegos = `
<iframe id="ifr" src="/system/apps/juegos/index.html" style="width:100%; height:100%;" frameborder="none"></iframe>
`
const terminal = `
...
{
  id: 2,
  imageSrc: '/media/icons/juegos.png',
  text: 'juegos',
  clickFunction: function() {
    createWindow('DuckOS juegos', juegos, '40%', '60%');
  }
},
{
  id: 3,
